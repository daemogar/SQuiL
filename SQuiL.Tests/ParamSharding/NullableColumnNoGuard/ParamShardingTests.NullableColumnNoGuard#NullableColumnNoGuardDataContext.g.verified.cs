//HintName: NullableColumnNoGuardDataContext.g.cs
// <auto-generated />
...
partial class NullableColumnNoGuardDataContext : SQuiLBaseDataContext
{
	public async Task<SQuiLResultType> ProcessNullableColumnNoGuardAsync(
		NullableColumnNoGuardRequest request,
		CancellationToken cancellationToken = default!)
	{
		...
		string inputPeople(List<DbParameter> parameters)
		{
			...
			foreach (var item in request.People)
			{
				...
				{
					throw new Exception($"NullableColumnNoGuardRequest table property [People] has a string property [NickName] with more than 50 characters.");
				}
			}
