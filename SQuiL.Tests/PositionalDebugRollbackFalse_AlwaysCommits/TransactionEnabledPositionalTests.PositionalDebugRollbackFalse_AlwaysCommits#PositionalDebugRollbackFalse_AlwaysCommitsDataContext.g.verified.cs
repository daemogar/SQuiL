//HintName: PositionalDebugRollbackFalse_AlwaysCommitsDataContext.g.cs
// <auto-generated />
...
partial class PositionalDebugRollbackFalse_AlwaysCommitsDataContext : SQuiLBaseDataContext
{
		...
		CancellationToken cancellationToken = default!)
	{
		...
		PositionalDebugRollbackFalse_AlwaysCommitsResponse response = new();
		...
		if (!isCount) errors.Add(new(51001, 12, 1, 81, "Count", "Expected return scaler `Count`"));
