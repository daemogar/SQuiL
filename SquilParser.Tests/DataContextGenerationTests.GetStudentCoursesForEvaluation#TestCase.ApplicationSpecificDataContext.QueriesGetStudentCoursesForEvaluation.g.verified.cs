//HintName: TestCase.ApplicationSpecificDataContext.QueriesGetStudentCoursesForEvaluation.g.cs
// <auto-generated />
...
partial class ApplicationSpecificDataContext : SQuiLBaseDataContext
{
	public async Task<ApplicationSpecificDataContextQueriesGetStudentCoursesForEvaluationResponse> ProcessQueriesGetStudentCoursesForEvaluationAsync(
		...
		CancellationToken cancellationToken = default!)
	{
		...
		ApplicationSpecificDataContextQueriesGetStudentCoursesForEvaluationResponse response = new();
		...
		string inputPeople()
		{
			...
			foreach(var item in request.People)
			{
				...
				query.Append(item.PersonID is null || item.PersonID.Length <= 10
					...
					: throw new Exception($"""
						ApplicationSpecificDataContextPeopleRequest model table property [People]
