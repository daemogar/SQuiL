//HintName: TestCase.ApplicationSpecificDataContext.QueriesExample.g.cs
// <auto-generated />
...
{
	public async Task<ApplicationSpecificDataContextQueriesExampleResponse> ProcessQueriesExampleAsync(
		...
		CancellationToken cancellationToken = default!)
	{
		...
		ApplicationSpecificDataContextQueriesExampleResponse response = new();
		...
		string inputSally()
		{
			...
			foreach(var item in request.Sally)
			{
				...
				query.Append(item.Jim is null || item.Jim.Length <= 20
					...
					: throw new Exception($"""
						ApplicationSpecificDataContextSallyRequest model table property [Sally]
