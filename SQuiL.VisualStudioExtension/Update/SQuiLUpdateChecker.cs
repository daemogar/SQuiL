...
using SQuiL.VisualStudioExtension.Options;

namespace SQuiL.VisualStudioExtension.Update;

/// <summary>
/// GitHub release check for the Visual Studio extension. Mirrors updateChecker.ts
/// in the VS Code extension and the identical copy in the SSMS extension.
...
internal static class SQuiLUpdateChecker
{
    ...
    private static HttpClient CreateClient()
    {
        ...
        c.DefaultRequestHeaders.UserAgent.ParseAdd("SQuiL-VisualStudioExtension");
